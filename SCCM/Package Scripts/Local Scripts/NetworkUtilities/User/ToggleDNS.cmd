...
(
	powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File "%~dp0Show-Toast.ps1" -Text "Adding or removing public DNS servers from network adapters. This may take a minute." -Title "Toggle DNS" -LauncherID "%~f0"
